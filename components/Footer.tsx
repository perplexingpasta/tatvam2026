    ...
    <footer className="bg-black text-white py-10 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto space-y-10">
        ...
        <div className="text-center border-b border-white/20 pb-6">
          <h2 className="text-base md:text-base tracking-wide font-semibold uppercase text-gray-400">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-bold border-b border-white/20 pb-2 inline-block">
              Quick Links
            </h3>
            <ul className="space-y-2 flex flex-col items-start text-base">
              <li>
                <Link
                  href="/registration"
        ...
        <div className="flex flex-col items-center pt-6 border-t border-white/20 space-y-3">
          ...
          <div className="text-center">
            <h1 className="text-2xl font-extrabold tracking-widest leading-none">
              TATVAM
            </h1>
            <p className="text-sm font-light tracking-[0.2em] mt-1 text-gray-400">
              2026
            </p>
          </div>
